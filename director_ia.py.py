...
def _briefing_serie_vencimientos(
    ...
    Detecta y normaliza la fecha de vencimiento de cualquier módulo.

    Si no encuentra una columna válida, devuelve una serie de NaT

    conservando el mismo índice del DataFrame.
    ...
    for columna in columnas_vencimiento:
        ...
        if vencimientos.notna().any():
            ...
            return vencimientos.dt.tz_convert(None)
...
def _briefing_estados(
    ...
    Detecta y normaliza la columna de estado de cualquier módulo.

    Si el módulo no posee una columna de estado reconocible,

    devuelve una serie vacía conservando el índice original.
...
def _briefing_serie_montos(
    ...
    Detecta la columna monetaria principal de cualquier módulo

    y convierte todos sus valores de manera segura.

    Conserva siempre el mismo índice del DataFrame.
    ...
    for columna in columnas_monetarias:
        ...
        return (
            ...
            .apply(_briefing_numero_monetario)

            .astype(float)

        )

    # En cajas y bancos puede no existir una columna única de monto.

    # En ese caso usamos ingreso como importe principal.
    ...
    # Si tampoco hay ingreso, usamos egreso.
    ...
    # El módulo no posee una columna monetaria reconocible.
...
def _briefing_numero_monetario(valor: Any) -> float:

    """

    Convierte de forma segura importes provenientes de Sheets.
    ...
    try:
        ...
        if "," in texto and "." in texto:
            ...
            if ultima_coma > ultimo_punto:
                ...
                # Formato argentino: 1.250.000,50
                ...
                # Formato internacional: 1,250,000.50
