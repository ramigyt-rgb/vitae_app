        ...
        with st.popover("✦ Copiloto Vitae", use_container_width=True):
            ...
            if final_question:
                try:
                    ...
                    # No duplicamos la respuesta fuera del historial: el chat queda limpio.
                    st.session_state["vitae_copilot_last_answer"] = answer
                    st.rerun()
                except Exception:
                    st.warning("Copiloto temporalmente no disponible. La plataforma puede seguir utilizándose normalmente.")
