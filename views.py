...
from director_ia import generar_resumen_ejecutivo
...
def render_dashboard() -> None:
    ...
    def render_resumen_empresas_pro(
        ...
        def egresos_del_mes(
            ...
            Suma los egresos del mes de caja y banco.

            """

            total = 0.0

            for nombre_modulo in [modulo_caja, modulo_banco]:

                df = obtener_df(nombre_modulo)

                if df.empty or "egreso" not in df.columns:
