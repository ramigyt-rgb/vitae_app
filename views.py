...
def render_facturacion_pro(module_name: str, cfg: Dict[str, Any]) -> None:
    ...
    # ORDENAR Y MOSTRAR FECHAS EN TABLA LIMPIA

    if "mes" in tabla_limpia.columns:

        original_mes = tabla_limpia["mes"].copy()
        ...
        tabla_limpia["_orden_fecha"] = fecha_iso.fillna(fecha_arg)
