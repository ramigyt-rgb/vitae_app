...
def render_facturacion_pro(module_name: str, cfg: Dict[str, Any]) -> None:
    ...
    # Fecha visible para tabla limpia

    fecha_cols = ["mes", "fecha", "fecha_factura", "fecha_pago", "vencimiento"]

    def fecha_valida(row):
    ...
    tabla_limpia["_fecha_real"] = tabla_limpia.apply(fecha_valida, axis=1)

    tabla_limpia["_orden_fecha"] = pd.to_datetime(

        tabla_limpia["_fecha_real"],
    ...
    tabla_limpia = tabla_limpia.drop(
        ...
        columns=["_fecha_real", "_orden_fecha"],
