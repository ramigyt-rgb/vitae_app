...
def _render_vitae_app_shell() -> None:
    ...
    st.markdown(
        ...
        [data-testid="stDataEditor"] {
            ...
            /* No ocultar el overflow: la barra flotante del editor (incluido
               el basurero para eliminar filas seleccionadas) puede quedar
               recortada en versiones recientes de Streamlit. */
...
def render_facturacion_pro(module_name: str, cfg: Dict[str, Any]) -> None:
    ...
    if active_workspace == "Editar tabla":
        ...
        if df.empty:
            ...
            # Un RangeIndex limpio evita que Streamlit trate el índice original
            # como una columna editable especial en modo dinámico. Esto mantiene
            # disponible la selección de filas + basurero de eliminación.
